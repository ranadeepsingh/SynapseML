...
spark = pyspark.sql.SparkSession.builder.appName("MyApp") \
            # Use 1.1.0 version for spark 4.0 and 1.0.15 version for Spark3.4
            .config("spark.jars.packages", "com.microsoft.azure:synapseml_2.13:1.1.0") \
...
// Use 1.1.0 version for spark 4.0 and 1.0.15 version for Spark3.4
libraryDependencies += "com.microsoft.azure" % "synapseml_2.13" % "1.1.0"
```
...
```bash
# Use 1.1.0 version for spark 4.0 and 1.0.15 version for Spark3.4
spark-shell --packages com.microsoft.azure:synapseml_2.13:1.1.0
...
For the coordinates use: `com.microsoft.azure:synapseml_2.13:1.1.0` for Spark4.0 Cluster and
...
Finally, ensure that your Spark cluster has at least Spark 4.0 and Scala 2.13.
